...
use Acme\DistribucionBundle\Entity\Cliente;
use Acme\DistribucionBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeDistribucionBundle:Cliente')->findAll();

        return $this->render('AcmeDistribucionBundle:Cliente:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AcmeDistribucionBundle:Cliente:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeDistribucionBundle:Cliente')->find($id);
        ...
        return $this->render('AcmeDistribucionBundle:Cliente:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AcmeDistribucionBundle:Cliente:edit.html.twig', array(
            'entity'      => $entity,
